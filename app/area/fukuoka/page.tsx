...
export const metadata = {
  title: '【2026最新】福岡の安いパーソナルジムおすすめ6選！料金比較',
  description: '【2026年4月最新】福岡の安いパーソナルジム6選を徹底比較。入会金+総額で本当にコスパの良いジムがわかる。',
}
...
const gyms = [
  {
    ...
    "description": "AI主導20分トレーニング。福岡エリア最安クラス。",
    "access": "天神駅 徒歩5分",
    "address": "福岡県福岡市中央区（天神駅徒歩5分）"
  },
  {
    "name": "BEYOND 福岡天神店",
    "rating": 4.7,
    ...
    "description": "入会金常時無料。福岡で人気No.1クラスのパーソナルジム。",
    "access": "天神駅 徒歩5分",
    "address": "福岡県福岡市中央区（天神駅徒歩5分）"
  },
  {
  ...
  },
  {
    ...
    "description": "月額制・縛りなし。完全個室60分マンツーマン。",
    "access": "福岡エリア",
    "address": "福岡県福岡市（福岡エリア）"
  },
  {
    ...
    "access": "博多駅 徒歩圏内",
    "address": "福岡県福岡市博多区（博多駅徒歩圏内）"
  }
]

const faqs = [
  {
    "question": "福岡で一番安いパーソナルジムは？",
    "answer": "ASPIが月2回7,600円〜で最安。エクササイズコーチも月4回9,900円〜。"
  },
  {
    "question": "福岡の相場は？",
    "answer": "東京より安め。天神・博多エリアに集中。"
  },
  {
    "question": "天神と博多どちらが良い？",
    "answer": "天神は通勤ルートに近い人向け。博多は新幹線利用者に便利。"
  }
]
    ...
    <>
      ...
      <section className="pt-24 pb-8 md:pt-28 bg-gradient-to-br from-primary-600 to-secondary-700 text-white">
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          <h1 className="text-2xl md:text-4xl font-bold mb-2 font-display">福岡の安いパーソナルジムおすすめ6選</h1>
          <p className="text-white/80 text-sm md:text-base">入会金+総額で比較！コスパ最強ジムがわかる【2026年4月最新】</p>
        </div>
      </section>
      <main className="max-w-6xl mx-auto px-4 lg:px-8 py-8">
        <TableOfContents items={[{ id: 'price-comparison', label: '福岡パーソナルジム料金比較表' }, ...gyms.map((g: any, i: number) => ({ id: `gym-${i + 1}`, label: `${i + 1}. ${g.name}` })), { id: 'market', label: '福岡エリアの料金相場' }, { id: 'faq', label: 'よくある質問' }]} />
        ...
        <section className="mt-12 bg-white border border-gray-200 rounded-xl p-6" id="market">
          <h2 className="text-xl font-bold text-site-text mb-4">福岡エリアの料金相場</h2>
          <p className="text-site-muted text-sm leading-relaxed mb-3">福岡の相場は東京より安め。天神・博多エリアに安いジムが集中。通勤ルートで選ぶのがポイント。</p>
        ...
        <section className="mt-8" id="faq">
          <h2 className="text-xl font-bold text-site-text mb-4">福岡のパーソナルジム よくある質問</h2>
        ...
        <RelatedAreas currentArea="fukuoka" />
      </main>
      <SiteFooter />
    </>
  )
